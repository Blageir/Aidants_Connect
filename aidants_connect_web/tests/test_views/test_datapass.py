...
class Datapass(TestCase):
    def setUp(self):
        self.good_data_from_datapass = {
            "contact_name": "Fabienne Cruzel",
            "contact_email": "email@organization.fr",
            "data_pass_id": "34",
    ...
    def test_message_body_can_create_organisation(self):
        ...
        self.assertEqual(
            Organisation.objects.first().contact_email, "email@organization.fr"
        )
        self.assertEqual(Organisation.objects.first().datapass_id, 34)
    ...
    def test_good_data_creates_email(self):
        ...
        self.assertIn("Fabienne Cruzel", email.body)
        self.assertIn("email@organization.fr", email.body)
